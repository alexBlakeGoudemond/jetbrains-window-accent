...
class CompatibilityVerificationTest {
    ...
    fun testShouldBeAvailableIsOverridden() {
        ...
        assertTrue(isOverridden, "WindowAccentToolWindowFactory should have shouldBeAvailable(Project)")
    }
    ...
    fun testDeprecatedAppScheduledExecutorServiceIsRemoved() {
        val sourcePath = Paths.get("src", "main", "kotlin", "com", "window_accent", "feature", "window_color", "WindowColorApplier.kt")
    ...
    /**
     * Ensures through reflection that these deprecated methods are not explicitly overridden in `WindowAccentToolWindowFactory`.
    ...
    fun testDeprecatedMethodsAreNotOverridden() {
        ...
        assertFalse(
            ...
            "WindowAccentToolWindowFactory should not override deprecated isApplicable. Found methods: $methodDetails"
        )
        assertFalse(
            isIsDoNotActivateOnStartOverridden,
            "WindowAccentToolWindowFactory should not override deprecated isDoNotActivateOnStart. Found methods: $methodDetails"
        )
    }

    /**
     * Verify that `getAnchor()`, `getIcon()`, and `manage()` are not explicitly overridden
     * in `WindowAccentToolWindowFactory`, preventing accidental use of experimental APIs.
     * */
    @Test
    fun testExperimentalMethodsAreNotOverridden() {
        ...
        assertFalse(
            ...
            "WindowAccentToolWindowFactory should not override experimental getAnchor. Found methods: $methodDetails"
        )
        assertFalse(
            isGetIconOverridden,
            "WindowAccentToolWindowFactory should not override experimental getIcon. Found methods: $methodDetails"
        )
        assertFalse(
            isManageOverridden,
            "WindowAccentToolWindowFactory should not override experimental manage. Found methods: $methodDetails"
        )
    }
